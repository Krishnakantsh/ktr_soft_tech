@extends('Admin.Pages.Authentication.Layout.main')
					...
					<div class="col-lg-5">
						<div class="login-background position-relative d-lg-flex align-items-center justify-content-center d-none flex-wrap vh-100">
							<div class="bg-overlay-img">
								<img src="{{asset('Backend/assets')}}/img/bg/bg-01.png" class="bg-1" alt="Img">
								<img src="{{asset('Backend/assets')}}/img/bg/bg-02.png" class="bg-2" alt="Img">
								<img src="{{asset('Backend/assets')}}/img/bg/bg-03.png" class="bg-3" alt="Img">
							</div>
							<div class="authentication-card w-100">
								<div class="authen-overlay-item border w-100">
									<h1 class="text-white display-1">Empowering people <br> through seamless HR <br> management.</h1>
									<div class="my-4 mx-auto authen-overlay-img">
										<img src="{{asset('Backend/assets')}}/img/bg/authentication-bg-01.png" alt="Img">
									</div>
									<div>
					...
					<div class="col-lg-7 col-md-12 col-sm-12">
						<div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap">
							<div class="col-md-7 mx-auto vh-100">
								<form action="https://smarthr.co.in/demo/html/template/index.html" class="vh-100">
									<div class="vh-100 d-flex flex-column justify-content-between p-4 pb-0">
										<div class=" mx-auto mb-5 text-center">
											<img src="{{asset('Backend/assets')}}/img/logo.svg"
										...
										<div class="">
											...
											<div class="d-flex align-items-center justify-content-between mb-3">
												...
												<div class="text-end">
													<a href="https://smarthr.co.in/demo/html/template/forgot-password.html" class="link-danger">Forgot Password?</a>
												</div>
											</div>
											<div class="mb-3">
												...
												<div class="d-flex align-items-center justify-content-center flex-wrap">
													<div class="text-center me-2 flex-fill">
														<a href="javascript:void(0);"
															...
															<img class="img-fluid m-1" src="{{asset('Backend/assets')}}/img/icons/facebook-logo.svg" alt="Facebook">
														</a>
													</div>
													<div class="text-center me-2 flex-fill">
														<a href="javascript:void(0);"
															class="br-10 p-2 btn btn-outline-light border d-flex align-items-center justify-content-center">
															<img class="img-fluid m-1" src="{{asset('Backend/assets')}}/img/icons/google-logo.svg" alt="Facebook">
														</a>
													</div>
													<div class="text-center flex-fill">
														<a href="javascript:void(0);"
															class="bg-dark br-10 p-2 btn btn-dark d-flex align-items-center justify-content-center">
															<img class="img-fluid m-1" src="{{asset('Backend/assets')}}/img/icons/apple-logo.svg" alt="Apple">
														</a>
													</div>
												</div>
											</div>
