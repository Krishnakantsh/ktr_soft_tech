					...
					<div class="col-lg-7 col-md-12 col-sm-12">
						<div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap">
							<div class="col-md-7 mx-auto vh-100">
								<form action="https://smarthr.co.in/demo/html/template/login.html" class="vh-100">
										...
										<div class="">
											...
											<div class="text-center">
												<h6 class="fw-normal text-dark mb-0">Already have an account?
													<a href="https://smarthr.co.in/demo/html/template/login.html" class="hover-a">Sign In</a>
												</h6>
											</div>
											<div class="login-or">
