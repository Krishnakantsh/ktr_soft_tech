...
<!-- Mirrored from smarthr.co.in/demo/html/template/index by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Aug 2025 17:14:15 GMT -->
<head>
									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li class="submenu">
													<a href="javascript:void(0);"><span>{{asset('Backend/assets')}}</span>
														<span class="menu-arrow"></span>
													</a>
													<ul>
														<li><a href="{{asset('Backend/assets')}}/index.html">{{asset('Backend/assets')}}</a></li>
										...
										<div class="d-flex flex-column">
												...
												<a href="activity.html">
													<div class="d-flex">
														<span class="avatar avatar-lg me-2 flex-shrink-0">
															<img src="{{asset('Backend/assets')}}/img/profiles/avatar-27.jpg" alt="Profile">
														</span>
											...
											<div class="border-bottom mb-3 pb-3">
												<a href="activity.html" class="pb-0">
													<div class="d-flex">
														<span class="avatar avatar-lg me-2 flex-shrink-0">
															<img src="{{asset('Backend/assets')}}/img/profiles/avatar-23.jpg" alt="Profile">
														</span>
														<div class="flex-grow-1">
															<p class="mb-1"><span
											...
											<div class="border-bottom mb-3 pb-3">
												<a href="activity.html">
													<div class="d-flex">
														<span class="avatar avatar-lg me-2 flex-shrink-0">
															<img src="{{asset('Backend/assets')}}/img/profiles/avatar-25.jpg" alt="Profile">
														</span>
														<div class="flex-grow-1">
											...
											<div class="border-0 mb-3 pb-0">
												<a href="activity.html">
													<div class="d-flex">
														<span class="avatar avatar-lg me-2 flex-shrink-0">
															<img src="{{asset('Backend/assets')}}/img/profiles/avatar-01.jpg" alt="Profile">
														</span>
														<div class="flex-grow-1">
							...
							<div class="dropdown profile-dropdown">
								<a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center"
									...
									<span class="avatar avatar-sm online">
										<img src="{{asset('Backend/assets')}}/img/profiles/avatar-12.jpg" alt="Img" class="img-fluid rounded-circle">
									</span>
								</a>
										...
										<div class="card-header">
											<div class="d-flex align-items-center">
												<span class="avatar avatar-lg me-2 avatar-rounded">
													<img src="{{asset('Backend/assets')}}/img/profiles/avatar-12.jpg" alt="img">
												</span>
												<div>
													<h5 class="mb-0">Kevin Larry</h5>
													<p class="fs-12 fw-medium mb-0"><a href="https://smarthr.co.in/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9becfae9e9fef5dbfee3faf6ebf7feb5f8f4f6">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
					...
					<ul>
						...
						<li>
							<ul>
								<li class="submenu">
									<a href="javascript:void(0);">
										<i class="ti ti-cash"></i><span>{{asset('Backend/assets')}}</span>
										<span class="menu-arrow"></span>
									</a>
									<ul>
										<li><a href="{{asset('Backend/assets')}}/index.html">{{asset('Backend/assets')}}</a></li>
						...
						<li>
							<ul>
								...
								<li>
									<a href="javascript:void(0);"><i class="ti ti-exchange"></i><span>Changelog</span><span class="badge bg-pink badge-xs text-white fs-10 ms-s">v4.0.8</span></a>
								</li>
								<li class="submenu">
				...
				<div class="main-menu">
					...
					<div class="d-xl-flex align-items-center d-none">
						<a href="#" class="me-3 avatar avatar-sm">
							<img src="{{asset('Backend/assets')}}/img/profiles/avatar-07.jpg" alt="profile" class="rounded-circle">
						</a>
